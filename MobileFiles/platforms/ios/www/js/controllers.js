...
.controller('ConfirmCtrl', function($scope, $stateParams, $http, $ionicLoading, $rootScope, $state,$window,EnvConfig,$cordovaInAppBrowserProvider){
	...
	$scope.payment = function(){
        ...
        /*$http({
			...
			$http({
				method: 'POST',
				url: 'http://localhost:8080/payment/1234'
                ...
                $cordovaInAppBrowserProvider.open(pmntResponse.data.data.pmntURL, '_system', 'location=yes');
